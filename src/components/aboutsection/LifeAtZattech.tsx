    ...
    <div class="text-black my-36 shadow-xl">
      <div class="text-center my-20">
        ...
        <p class="text-lg my-8  dark:text-white">
          ...
          innovation, and the desire to push boundaries in technology. Every day
          presents new opportunities for growth and learning, as we work
          together to deliver cutting-edge solutions for our clients. Join us in
          shaping the future of tech, where your ideas and contributions truly
          make a difference.
        </p>
      </div>
      <div class="flex my-32 shadow-xl">
        <div class="grid grid-cols-12  col-span-6">
          ...
          <div class="col-span-7 md:mt-44 px-4 ">
            ...
            <p class="text-wrap  text-xs md:text-lg my-4 md:my-9 dark:text-white">
              ...
              education, on-the-job training, workshops, certifications, and
              personal study. Staying updated with industry trends and
            ...
            <p class="text-wrap text-xs md:text-lg mb-2 dark:text-white ">
              ...
              self-improvement and seeking mentorship, individuals can remain
              adaptable and prepared for the challenges of an evolving
              workforce.
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-12  col-span-6">
          <div class="col-span-7 md:mt-44 px-4 ">
            ...
            <p class="text-wrap  text-xs md:text-lg my-4 md:my-9 dark:text-white">
              ...
              focusing on solving specific problems or meeting user needs. Next,
            ...
            <p class="text-wrap text-xs md:text-lg mb-2 dark:text-white">
              ...
              functionality while keeping the interface simple and visually
              appealing. Finally, iterating on feedback from early testing helps
              refine the app before moving into full development and deployment
              stages.
            </p>
          </div>
          <div class="col-span-5">
            <img src="Plan.png" alt="loading.." class="w-full" />
          </div>
        </div>
      </div>{" "}
      <div class="flex my-32 shadow-xl">
        <div class="grid grid-cols-12  col-span-6">
          ...
          <div class="col-span-7 md:mt-44 px-4 ">
            ...
            <p class="text-wrap  text-xs md:text-lg my-4 md:my-9 dark:text-white">
              ...
              and team-building activities are regular fixtures. Whether it’s a
            ...
            <p class="text-wrap text-xs md:text-lg mb-2 dark:text-white">
              ...
              casual lounges, to ensure that our team stays energized and
